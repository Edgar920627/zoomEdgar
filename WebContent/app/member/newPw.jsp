	...
	<header id="header"></header> 
		...
		<div class="wrapper">
			...
			<section class="main">
				...
				<form action="${pageContext.request.contextPath}/member/MemberFind.me" method="post" id="emailForm" name="emailForm">
   				 ...
   				 <table class="alt"  style="width:35%; margin:40px auto; height:100%; border: 2px solid #FFBF00; background-color: #FFFFFF; ">
							...
							<tr style="padding: 20px;">
								...
								<td>
									<input type="text" value="${session_id}" style="width:250px; font-size: 10px;" id="user_id" name="user_id" readonly />
							...
							<tr style="padding: 20px;">
								...
								<td><input type="text" value="${session_email}" style="width:250px; font-size: 10px;" name="user_email" readonly/></td>
							</tr>
						...
						<ul class="actions fit" >
							...
							<a href="javascript:formSubmit()" class="button primary fit" style="width:150px; font-size: 13px;">비밀번호 변경</a></li>
						</ul>
					</form>	
